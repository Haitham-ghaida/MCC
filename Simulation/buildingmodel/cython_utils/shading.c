...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "include_dirs": [
            "C:\\ProgramData\\Anaconda3\\envs\\shape_optim_env\\lib\\site-packages\\numpy\\core\\include"
        ],
        "name": "shape_optim.buildingmodel.cython_utils.shading",
        "sources": [
            "shape_optim/buildingmodel/cython_utils/shading.pyx"
        ]
    },
    "module_name": "shape_optim.buildingmodel.cython_utils.shading"
}
END: Cython Metadata */
...
#define __PYX_HAVE__shape_optim__buildingmodel__cython_utils__shading
#define __PYX_HAVE_API__shape_optim__buildingmodel__cython_utils__shading
/* Early includes */
#include <math.h>
#include "pythread.h"
#include <string.h>
...
/* Module declarations from 'shape_optim.buildingmodel.cython_utils.shading' */
...
static PyObject *__pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_calculate_shading(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, double, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_discretize_polygons(__Pyx_memviewslice, __Pyx_memviewslice, double, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_visible_beam(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "shape_optim.buildingmodel.cython_utils.shading"
extern int __pyx_module_is_main_shape_optim__buildingmodel__cython_utils__shading;
int __pyx_module_is_main_shape_optim__buildingmodel__cython_utils__shading = 0;

/* Implementation of 'shape_optim.buildingmodel.cython_utils.shading' */
...
static const char __pyx_k_sun_height[] = "sun_height";
static const char __pyx_k_MemoryError[] = "MemoryError";
static const char __pyx_k_PickleError[] = "PickleError";
static const char __pyx_k_bbox_filter[] = "bbox_filter";
static const char __pyx_k_sun_azimuth[] = "sun_azimuth";
static const char __pyx_k_polygon_ends[] = "polygon_ends";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_shading_mask[] = "shading_mask";
...
static const char __pyx_k_elevation_model[] = "elevation_model";
static const char __pyx_k_pyx_PickleError[] = "__pyx_PickleError";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_boundary_centers[] = "boundary_centers";
static const char __pyx_k_boundary_azimuths[] = "boundary_azimuths";
...
static PyObject *__pyx_n_s_bbox_filter;
static PyObject *__pyx_n_s_boundary_azimuths;
static PyObject *__pyx_n_s_boundary_centers;
...
static PyObject *__pyx_n_s_elevation_model;
...
static PyObject *__pyx_n_s_polygon_ends;
...
static PyObject *__pyx_n_s_shading_mask;
...
static PyObject *__pyx_n_s_sun_azimuth;
static PyObject *__pyx_n_s_sun_height;
...
static PyObject *__pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_calculate_shading(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_boundary_centers, __Pyx_memviewslice __pyx_v_elevation_model, __Pyx_memviewslice __pyx_v_boundary_azimuths, double __pyx_v_angular_resolution, double __pyx_v_bbox_filter, __Pyx_memviewslice __pyx_v_boundary_type); /* proto */
static PyObject *__pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_2discretize_polygons(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_polygons, __Pyx_memviewslice __pyx_v_polygon_ends, double __pyx_v_resolution); /* proto */
static PyObject *__pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_4visible_beam(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_shading_mask, __Pyx_memviewslice __pyx_v_sun_height, __Pyx_memviewslice __pyx_v_sun_azimuth); /* proto */
...
/* "shape_optim/buildingmodel/cython_utils/shading.pyx":5
 * import numpy as np
 * 
...
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_1calculate_shading(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_calculate_shading(__Pyx_memviewslice __pyx_v_boundary_centers, __Pyx_memviewslice __pyx_v_elevation_model, __Pyx_memviewslice __pyx_v_boundary_azimuths, double __pyx_v_angular_resolution, double __pyx_v_bbox_filter, __Pyx_memviewslice __pyx_v_boundary_type, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_k;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_shading_id;
  Py_ssize_t __pyx_v_end;
  Py_ssize_t __pyx_v_start;
  Py_ssize_t __pyx_v_boundary_count;
  Py_ssize_t __pyx_v_elevation_count;
  double __pyx_v_height;
  double __pyx_v_azimuth;
  double __pyx_v_distance;
  Py_ssize_t __pyx_v_shading_count;
  PyObject *__pyx_v_shading = NULL;
  __Pyx_memviewslice __pyx_v_shading_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("calculate_shading", 0);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":10
 ...
 */
  __pyx_v_boundary_count = (__pyx_v_boundary_centers.shape[0]);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":11
 *     cdef double height, azimuth, distance
 *     boundary_count = boundary_centers.shape[0]
 *     elevation_count = elevation_model.shape[0]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t shading_count = <Py_ssize_t>(360. / angular_resolution + 1.)
 ...
 */
  __pyx_v_elevation_count = (__pyx_v_elevation_model.shape[0]);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":12
 *     boundary_count = boundary_centers.shape[0]
 *     elevation_count = elevation_model.shape[0]
 *     cdef Py_ssize_t shading_count = <Py_ssize_t>(360. / angular_resolution + 1.)             # <<<<<<<<<<<<<<
 *     shading = np.zeros((boundary_count, shading_count), dtype=np.float64)
 ...
 */
  __pyx_v_shading_count = ((Py_ssize_t)((360. / __pyx_v_angular_resolution) + 1.));

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":13
 *     elevation_count = elevation_model.shape[0]
 *     cdef Py_ssize_t shading_count = <Py_ssize_t>(360. / angular_resolution + 1.)
 *     shading = np.zeros((boundary_count, shading_count), dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:, ::1] shading_view = shading
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_boundary_count); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_shading_count); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  __pyx_v_shading = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":14
 *     cdef Py_ssize_t shading_count = <Py_ssize_t>(360. / angular_resolution + 1.)
 *     shading = np.zeros((boundary_count, shading_count), dtype=np.float64)
 *     cdef double[:, ::1] shading_view = shading             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_v_shading, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 14, __pyx_L1_error)
  __pyx_v_shading_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":16
 *     cdef double[:, ::1] shading_view = shading
 * 
 *     for k in range(boundary_count):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = __pyx_v_boundary_count;
  __pyx_t_8 = __pyx_t_7;
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_k = __pyx_t_9;

    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":18
 *     for k in range(boundary_count):
 * 
 *         if boundary_type[k] == 0: # Exterior Wall             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_boundary_type.shape[0];
    __pyx_t_11 = (((*((int *) ( /* dim=0 */ (__pyx_v_boundary_type.data + __pyx_t_10 * __pyx_v_boundary_type.strides[0]) ))) == 0) != 0);
    if (__pyx_t_11) {

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":20
 *         if boundary_type[k] == 0: # Exterior Wall
 *             # We set to 90 all azimuths that are behind the wall studied
 *             start = <Py_ssize_t>((boundary_azimuths[k] + 90. )/ angular_resolution)             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_10 = __pyx_v_k;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_boundary_azimuths.shape[0];
      __pyx_v_start = ((Py_ssize_t)(((*((double *) ( /* dim=0 */ (__pyx_v_boundary_azimuths.data + __pyx_t_10 * __pyx_v_boundary_azimuths.strides[0]) ))) + 90.) / __pyx_v_angular_resolution));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":21
 *             # We set to 90 all azimuths that are behind the wall studied
 *             start = <Py_ssize_t>((boundary_azimuths[k] + 90. )/ angular_resolution)
 *             end = start +  <Py_ssize_t>(180. / angular_resolution) + 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_end = ((__pyx_v_start + ((Py_ssize_t)(180. / __pyx_v_angular_resolution))) + 1);

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":23
 *             end = start +  <Py_ssize_t>(180. / angular_resolution) + 1
 * 
 *             if end <= shading_count:             # <<<<<<<<<<<<<<
 ...
 *                     shading_view[k, i] = 90.
 */
      __pyx_t_11 = ((__pyx_v_end <= __pyx_v_shading_count) != 0);
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":24
 * 
 *             if end <= shading_count:
 *                 for i in range(start, end):             # <<<<<<<<<<<<<<
 *                     shading_view[k, i] = 90.
 ...
 */
        ...
        for (__pyx_t_14 = __pyx_v_start; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
          ...
          /* "shape_optim/buildingmodel/cython_utils/shading.pyx":25
 *             if end <= shading_count:
 *                 for i in range(start, end):
 *                     shading_view[k, i] = 90.             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
          ...
          if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_shading_view.shape[0];
          if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_shading_view.shape[1];
          *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_shading_view.data + __pyx_t_10 * __pyx_v_shading_view.strides[0]) )) + __pyx_t_15)) )) = 90.;
        }
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":27
 *                     shading_view[k, i] = 90.
 *             else:
 *                 for i in range(start, shading_count):             # <<<<<<<<<<<<<<
 *                     shading_view[k, i] = 90.
 ...
 */
      /*else*/ {
        __pyx_t_12 = __pyx_v_shading_count;
        __pyx_t_13 = __pyx_t_12;
        for (__pyx_t_14 = __pyx_v_start; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
          __pyx_v_i = __pyx_t_14;

          /* "shape_optim/buildingmodel/cython_utils/shading.pyx":28
 *             else:
 *                 for i in range(start, shading_count):
 *                     shading_view[k, i] = 90.             # <<<<<<<<<<<<<<
 *                 for i in range(end - shading_count):
 ...
 */
          ...
          if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_shading_view.shape[0];
          if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_shading_view.shape[1];
          *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_shading_view.data + __pyx_t_15 * __pyx_v_shading_view.strides[0]) )) + __pyx_t_10)) )) = 90.;
        }

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":29
 *                 for i in range(start, shading_count):
 *                     shading_view[k, i] = 90.
 *                 for i in range(end - shading_count):             # <<<<<<<<<<<<<<
 *                     shading_view[k, i] = 90.
 * 
 */
        __pyx_t_12 = (__pyx_v_end - __pyx_v_shading_count);
        __pyx_t_13 = __pyx_t_12;
        for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
          __pyx_v_i = __pyx_t_14;

          /* "shape_optim/buildingmodel/cython_utils/shading.pyx":30
 *                     shading_view[k, i] = 90.
 *                 for i in range(end - shading_count):
 *                     shading_view[k, i] = 90.             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":32
 *                     shading_view[k, i] = 90.
 * 
 *         if boundary_type[k] == 1 or boundary_type[k] == 3: # Interior wall or Floor             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    __pyx_t_15 = __pyx_v_k;
    if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_boundary_type.shape[0];
    __pyx_t_16 = (((*((int *) ( /* dim=0 */ (__pyx_v_boundary_type.data + __pyx_t_15 * __pyx_v_boundary_type.strides[0]) ))) == 1) != 0);
    if (!__pyx_t_16) {
    } else {
    ...
    __pyx_t_15 = __pyx_v_k;
    if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_boundary_type.shape[0];
    __pyx_t_16 = (((*((int *) ( /* dim=0 */ (__pyx_v_boundary_type.data + __pyx_t_15 * __pyx_v_boundary_type.strides[0]) ))) == 3) != 0);
    __pyx_t_11 = __pyx_t_16;
    __pyx_L14_bool_binop_done:;
    if (__pyx_t_11) {

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":33
 * 
 *         if boundary_type[k] == 1 or boundary_type[k] == 3: # Interior wall or Floor
 *             continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":35
 *             continue
 * 
 *         for j in range(elevation_count):             # <<<<<<<<<<<<<<
 ...
 *                 continue
 */
    __pyx_t_12 = __pyx_v_elevation_count;
    __pyx_t_13 = __pyx_t_12;
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      __pyx_v_j = __pyx_t_14;

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":36
 * 
 *         for j in range(elevation_count):
 *             if elevation_model[j, 2] <= boundary_centers[k, 2]:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      __pyx_t_10 = 2;
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_elevation_model.shape[0];
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_elevation_model.shape[1];
      __pyx_t_17 = __pyx_v_k;
      __pyx_t_18 = 2;
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_boundary_centers.shape[1];
      __pyx_t_11 = (((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_15 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_10)) ))) <= (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_17 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_18)) )))) != 0);
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":37
 *         for j in range(elevation_count):
 *             if elevation_model[j, 2] <= boundary_centers[k, 2]:
 *                 continue             # <<<<<<<<<<<<<<
 *             if elevation_model[j, 0] > boundary_centers[k, 0] + bbox_filter or elevation_model[j, 0] < boundary_centers[k, 0] - bbox_filter:
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":38
 *             if elevation_model[j, 2] <= boundary_centers[k, 2]:
 *                 continue
 *             if elevation_model[j, 0] > boundary_centers[k, 0] + bbox_filter or elevation_model[j, 0] < boundary_centers[k, 0] - bbox_filter:             # <<<<<<<<<<<<<<
 *                 if elevation_model[j, 1] > boundary_centers[k, 1] + bbox_filter or elevation_model[j, 1] < boundary_centers[k, 1] - bbox_filter:
 ...
 */
      ...
      __pyx_t_17 = 0;
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_elevation_model.shape[0];
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_elevation_model.shape[1];
      __pyx_t_10 = __pyx_v_k;
      __pyx_t_15 = 0;
      if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_boundary_centers.shape[1];
      __pyx_t_16 = (((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_18 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_17)) ))) > ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_10 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_15)) ))) + __pyx_v_bbox_filter)) != 0);
      if (!__pyx_t_16) {
      } else {
        __pyx_t_11 = __pyx_t_16;
      ...
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_boundary_centers.shape[1];
      __pyx_t_16 = (((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_15 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_10)) ))) < ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_17 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_18)) ))) - __pyx_v_bbox_filter)) != 0);
      __pyx_t_11 = __pyx_t_16;
      __pyx_L20_bool_binop_done:;
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":39
 *                 continue
 *             if elevation_model[j, 0] > boundary_centers[k, 0] + bbox_filter or elevation_model[j, 0] < boundary_centers[k, 0] - bbox_filter:
 *                 if elevation_model[j, 1] > boundary_centers[k, 1] + bbox_filter or elevation_model[j, 1] < boundary_centers[k, 1] - bbox_filter:             # <<<<<<<<<<<<<<
 *                     continue
 ...
 */
        ...
        if (__pyx_t_11) {
          ...
          /* "shape_optim/buildingmodel/cython_utils/shading.pyx":40
 *             if elevation_model[j, 0] > boundary_centers[k, 0] + bbox_filter or elevation_model[j, 0] < boundary_centers[k, 0] - bbox_filter:
 *                 if elevation_model[j, 1] > boundary_centers[k, 1] + bbox_filter or elevation_model[j, 1] < boundary_centers[k, 1] - bbox_filter:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":43
 * 
 *             # We compute the azimuth
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":44
 *             # We compute the azimuth
 *             azimuth = (math.atan2((elevation_model[j, 1] - boundary_centers[k, 1]),
 *                                   (elevation_model[j, 0] - boundary_centers[k, 0]))) * 180. / math.pi             # <<<<<<<<<<<<<<
 *             if azimuth < 0.:
 ...
 */
      ...
      __pyx_t_20 = 0;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_elevation_model.shape[0];
      if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_elevation_model.shape[1];
      __pyx_t_21 = __pyx_v_k;
      __pyx_t_22 = 0;
      if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_boundary_centers.shape[1];
 ...
 *             if azimuth < 0.:
 */
      __pyx_v_azimuth = ((atan2(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_18 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_17)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_10 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_15)) )))), ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_19 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_20)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_21 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_22)) ))))) * 180.) / ((double)M_PI));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":45
 *             azimuth = (math.atan2((elevation_model[j, 1] - boundary_centers[k, 1]),
 *                                   (elevation_model[j, 0] - boundary_centers[k, 0]))) * 180. / math.pi
 *             if azimuth < 0.:             # <<<<<<<<<<<<<<
 *                 azimuth += 360.
 * 
 */
      __pyx_t_11 = ((__pyx_v_azimuth < 0.) != 0);
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":46
 *                                   (elevation_model[j, 0] - boundary_centers[k, 0]))) * 180. / math.pi
 *             if azimuth < 0.:
 *                 azimuth += 360.             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_azimuth = (__pyx_v_azimuth + 360.);
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":48
 *                 azimuth += 360.
 * 
 *             shading_id = <Py_ssize_t>(azimuth / angular_resolution)             # <<<<<<<<<<<<<<
 ...
 *                 continue
 */
      __pyx_v_shading_id = ((Py_ssize_t)(__pyx_v_azimuth / __pyx_v_angular_resolution));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":49
 * 
 *             shading_id = <Py_ssize_t>(azimuth / angular_resolution)
 *             if shading_view[k, shading_id] == 90.:             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      __pyx_t_21 = __pyx_v_shading_id;
      if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_shading_view.shape[0];
      if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_shading_view.shape[1];
      __pyx_t_11 = (((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_shading_view.data + __pyx_t_22 * __pyx_v_shading_view.strides[0]) )) + __pyx_t_21)) ))) == 90.) != 0);
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":50
 *             shading_id = <Py_ssize_t>(azimuth / angular_resolution)
 *             if shading_view[k, shading_id] == 90.:
 *                 continue             # <<<<<<<<<<<<<<
 *             # we compute the distance between the two points
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":52
 *                 continue
 *             # we compute the distance between the two points
 *             distance = math.sqrt((elevation_model[j, 0] - boundary_centers[k, 0]) ** 2 +             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_22 = 0;
      if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_elevation_model.shape[0];
      if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_elevation_model.shape[1];
      __pyx_t_20 = __pyx_v_k;
      __pyx_t_19 = 0;
      if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_boundary_centers.shape[1];

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":53
 *             # we compute the distance between the two points
 *             distance = math.sqrt((elevation_model[j, 0] - boundary_centers[k, 0]) ** 2 +
 *                                  (elevation_model[j, 1] - boundary_centers[k, 1]) ** 2 +             # <<<<<<<<<<<<<<
 *                                  (elevation_model[j, 2] - boundary_centers[k, 2]) ** 2)
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":54
 *             distance = math.sqrt((elevation_model[j, 0] - boundary_centers[k, 0]) ** 2 +
 *                                  (elevation_model[j, 1] - boundary_centers[k, 1]) ** 2 +
 *                                  (elevation_model[j, 2] - boundary_centers[k, 2]) ** 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_24 = 2;
      if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_v_elevation_model.shape[0];
      if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_elevation_model.shape[1];
      __pyx_t_25 = __pyx_v_k;
      __pyx_t_26 = 2;
      if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_v_boundary_centers.shape[1];
 ...
 *                                  (elevation_model[j, 2] - boundary_centers[k, 2]) ** 2)
 */
      __pyx_v_distance = sqrt(((pow(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_21 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_22)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_20 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_19)) )))), 2.0) + pow(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_15 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_10)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_17 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_18)) )))), 2.0)) + pow(((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_23 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_24)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_25 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_26)) )))), 2.0)));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":57
 * 
 *             # We compute the height
 ...
 */
      ...
      __pyx_t_25 = 2;
      if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_v_elevation_model.shape[0];
      if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_v_elevation_model.shape[1];
      __pyx_t_24 = __pyx_v_k;
      __pyx_t_23 = 2;
      if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_boundary_centers.shape[0];
      if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_v_boundary_centers.shape[1];
      __pyx_v_height = ((asin((((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_elevation_model.data + __pyx_t_26 * __pyx_v_elevation_model.strides[0]) )) + __pyx_t_25)) ))) - (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_boundary_centers.data + __pyx_t_24 * __pyx_v_boundary_centers.strides[0]) )) + __pyx_t_23)) )))) / __pyx_v_distance)) * 180.) / ((double)M_PI));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":59
 *             height = (math.asin((elevation_model[j, 2] - boundary_centers[k, 2]) / distance)) * 180. / math.pi
 * 
 *             if height > shading_view[k, shading_id]:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_24 = __pyx_v_shading_id;
      if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_v_shading_view.shape[0];
      if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_shading_view.shape[1];
      __pyx_t_11 = ((__pyx_v_height > (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_shading_view.data + __pyx_t_23 * __pyx_v_shading_view.strides[0]) )) + __pyx_t_24)) )))) != 0);
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":60
 * 
 *             if height > shading_view[k, shading_id]:
 *                 shading_view[k, shading_id] = height             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_24 = __pyx_v_k;
        __pyx_t_23 = __pyx_v_shading_id;
        if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_shading_view.shape[0];
        if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_v_shading_view.shape[1];
        *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_shading_view.data + __pyx_t_24 * __pyx_v_shading_view.strides[0]) )) + __pyx_t_23)) )) = __pyx_v_height;
 ...
 */
  ...
  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":62
 *                 shading_view[k, shading_id] = height
 * 
 *     return shading             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("shape_optim.buildingmodel.cython_utils.shading.calculate_shading", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_shading);
  __PYX_XDEC_MEMVIEW(&__pyx_v_shading_view, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_1calculate_shading(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_1calculate_shading(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_boundary_centers = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_elevation_model = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_boundary_azimuths = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_angular_resolution;
  double __pyx_v_bbox_filter;
  __Pyx_memviewslice __pyx_v_boundary_type = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculate_shading (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_boundary_centers,&__pyx_n_s_elevation_model,&__pyx_n_s_boundary_azimuths,&__pyx_n_s_angular_resolution,&__pyx_n_s_bbox_filter,&__pyx_n_s_boundary_type,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_boundary_centers)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_elevation_model)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_shading", 1, 6, 6, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_boundary_azimuths)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_shading", 1, 6, 6, 2); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_angular_resolution)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_shading", 1, 6, 6, 3); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bbox_filter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_shading", 1, 6, 6, 4); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_boundary_type)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_shading", 1, 6, 6, 5); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_shading") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_boundary_centers = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_boundary_centers.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_elevation_model = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_elevation_model.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_boundary_azimuths = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_boundary_azimuths.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_angular_resolution = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_angular_resolution == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_bbox_filter = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_bbox_filter == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_boundary_type = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_boundary_type.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_shading", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("shape_optim.buildingmodel.cython_utils.shading.calculate_shading", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_calculate_shading(__pyx_self, __pyx_v_boundary_centers, __pyx_v_elevation_model, __pyx_v_boundary_azimuths, __pyx_v_angular_resolution, __pyx_v_bbox_filter, __pyx_v_boundary_type);
...
static PyObject *__pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_calculate_shading(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_boundary_centers, __Pyx_memviewslice __pyx_v_elevation_model, __Pyx_memviewslice __pyx_v_boundary_azimuths, double __pyx_v_angular_resolution, double __pyx_v_bbox_filter, __Pyx_memviewslice __pyx_v_boundary_type) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("calculate_shading", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_calculate_shading(__pyx_v_boundary_centers, __pyx_v_elevation_model, __pyx_v_boundary_azimuths, __pyx_v_angular_resolution, __pyx_v_bbox_filter, __pyx_v_boundary_type, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_boundary_centers, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_elevation_model, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_boundary_azimuths, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_boundary_type, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "shape_optim/buildingmodel/cython_utils/shading.pyx":66
 * 
 * 
...
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_3discretize_polygons(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_discretize_polygons(__Pyx_memviewslice __pyx_v_polygons, __Pyx_memviewslice __pyx_v_polygon_ends, double __pyx_v_resolution, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_k;
  __Pyx_memviewslice __pyx_v_point_counts = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_total_points;
  __Pyx_memviewslice __pyx_v_vertice_lengths = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_start;
  Py_ssize_t __pyx_v_end;
  __Pyx_memviewslice __pyx_v_current_edge = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_next_edge = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_vertice_direction = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_points = NULL;
  __Pyx_memviewslice __pyx_v_point_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_point_index;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("discretize_polygons", 0);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":71
 *     cdef Py_ssize_t j
 *     cdef Py_ssize_t k
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_polygons.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_point_counts = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":72
 *     cdef Py_ssize_t k
 *     cdef int[:] point_counts = np.zeros(polygons.shape[0], dtype=np.int32)
 *     cdef int total_points = 0             # <<<<<<<<<<<<<<
 *     cdef double[:] vertice_lengths = np.zeros(polygons.shape[0], dtype=np.float64)
 ...
 */
  __pyx_v_total_points = 0;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":73
 *     cdef int[:] point_counts = np.zeros(polygons.shape[0], dtype=np.int32)
 *     cdef int total_points = 0
 *     cdef double[:] vertice_lengths = np.zeros(polygons.shape[0], dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t start = 0
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t((__pyx_v_polygons.shape[0])); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_4, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_vertice_lengths = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":74
 *     cdef int total_points = 0
 *     cdef double[:] vertice_lengths = np.zeros(polygons.shape[0], dtype=np.float64)
 *     cdef Py_ssize_t start = 0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t end = 0
 ...
 */
  ...
  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":75
 *     cdef double[:] vertice_lengths = np.zeros(polygons.shape[0], dtype=np.float64)
 *     cdef Py_ssize_t start = 0
 *     cdef Py_ssize_t end = 0             # <<<<<<<<<<<<<<
 *     cdef double[:] current_edge = np.zeros(3, dtype=np.float64)
 ...
 */
  ...
  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":76
 *     cdef Py_ssize_t start = 0
 *     cdef Py_ssize_t end = 0
 *     cdef double[:] current_edge = np.zeros(3, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:] next_edge = np.zeros(3, dtype=np.float64)
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_tuple_, __pyx_t_4); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 76, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_current_edge = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":77
 *     cdef Py_ssize_t end = 0
 *     cdef double[:] current_edge = np.zeros(3, dtype=np.float64)
 *     cdef double[:] next_edge = np.zeros(3, dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:] vertice_direction = np.zeros(2, dtype=np.float64)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float64); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_tuple_, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_next_edge = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":78
 *     cdef double[:] current_edge = np.zeros(3, dtype=np.float64)
 *     cdef double[:] next_edge = np.zeros(3, dtype=np.float64)
 *     cdef double[:] vertice_direction = np.zeros(2, dtype=np.float64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_tuple__2, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_vertice_direction = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":80
 *     cdef double[:] vertice_direction = np.zeros(2, dtype=np.float64)
 * 
 *     for i in range(polygon_ends.shape[0]):             # <<<<<<<<<<<<<<
 *         start = 0
 *         if i > 0:
 */
  __pyx_t_8 = (__pyx_v_polygon_ends.shape[0]);
  __pyx_t_9 = __pyx_t_8;
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    __pyx_v_i = __pyx_t_10;

    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":81
 * 
 *     for i in range(polygon_ends.shape[0]):
 *         start = 0             # <<<<<<<<<<<<<<
 *         if i > 0:
 ...
 */
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":82
 *     for i in range(polygon_ends.shape[0]):
 *         start = 0
 *         if i > 0:             # <<<<<<<<<<<<<<
 *             start = polygon_ends[i-1] + 1
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":83
 *         start = 0
 *         if i > 0:
 *             start = polygon_ends[i-1] + 1             # <<<<<<<<<<<<<<
 *         end = polygon_ends[i]
 ...
 */
      ...
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_polygon_ends.shape[0];
      __pyx_v_start = ((*((int *) ( /* dim=0 */ (__pyx_v_polygon_ends.data + __pyx_t_12 * __pyx_v_polygon_ends.strides[0]) ))) + 1);
 ...
 */
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":84
 *         if i > 0:
 *             start = polygon_ends[i-1] + 1
 *         end = polygon_ends[i]             # <<<<<<<<<<<<<<
 *         for j in range(start, end):
 ...
 */
    ...
    if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_polygon_ends.shape[0];
    __pyx_v_end = (*((int *) ( /* dim=0 */ (__pyx_v_polygon_ends.data + __pyx_t_12 * __pyx_v_polygon_ends.strides[0]) )));

    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":85
 *             start = polygon_ends[i-1] + 1
 *         end = polygon_ends[i]
 *         for j in range(start, end):             # <<<<<<<<<<<<<<
 *             current_edge = polygons[j, :]
 ...
 */
    ...
    for (__pyx_t_15 = __pyx_v_start; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":86
 *         end = polygon_ends[i]
 *         for j in range(start, end):
 *             current_edge = polygons[j, :]             # <<<<<<<<<<<<<<
 *             next_edge = polygons[j + 1, :]
 ...
 */
      __pyx_t_16.data = __pyx_v_polygons.data;
      __pyx_t_16.memview = __pyx_v_polygons.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_16, 0);
      {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_j;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_polygons.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_polygons.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_16.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_16.shape[0] = __pyx_v_polygons.shape[1];
__pyx_t_16.strides[0] = __pyx_v_polygons.strides[1];
    __pyx_t_16.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_current_edge, 1);
      __pyx_v_current_edge = __pyx_t_16;
      __pyx_t_16.memview = NULL;
      __pyx_t_16.data = NULL;

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":87
 *         for j in range(start, end):
 *             current_edge = polygons[j, :]
 *             next_edge = polygons[j + 1, :]             # <<<<<<<<<<<<<<
 *             vertice_lengths[j] = math.sqrt((next_edge[0] - current_edge[0]) ** 2 + (next_edge[1] - current_edge[1]) ** 2)
...
__PYX_XDEC_MEMVIEW(&__pyx_v_next_edge, 1);
      __pyx_v_next_edge = __pyx_t_16;
      __pyx_t_16.memview = NULL;
      __pyx_t_16.data = NULL;

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":88
 *             current_edge = polygons[j, :]
 *             next_edge = polygons[j + 1, :]
 *             vertice_lengths[j] = math.sqrt((next_edge[0] - current_edge[0]) ** 2 + (next_edge[1] - current_edge[1]) ** 2)             # <<<<<<<<<<<<<<
 *             if vertice_lengths[j] == 0.:
 ...
 */
      __pyx_t_12 = 0;
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_next_edge.shape[0];
      __pyx_t_17 = 0;
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_current_edge.shape[0];
      __pyx_t_18 = 1;
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_next_edge.shape[0];
      __pyx_t_19 = 1;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_current_edge.shape[0];
      __pyx_t_20 = __pyx_v_j;
      if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_vertice_lengths.shape[0];
      *((double *) ( /* dim=0 */ (__pyx_v_vertice_lengths.data + __pyx_t_20 * __pyx_v_vertice_lengths.strides[0]) )) = sqrt((pow(((*((double *) ( /* dim=0 */ (__pyx_v_next_edge.data + __pyx_t_12 * __pyx_v_next_edge.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_17 * __pyx_v_current_edge.strides[0]) )))), 2.0) + pow(((*((double *) ( /* dim=0 */ (__pyx_v_next_edge.data + __pyx_t_18 * __pyx_v_next_edge.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_19 * __pyx_v_current_edge.strides[0]) )))), 2.0)));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":89
 *             next_edge = polygons[j + 1, :]
 *             vertice_lengths[j] = math.sqrt((next_edge[0] - current_edge[0]) ** 2 + (next_edge[1] - current_edge[1]) ** 2)
 *             if vertice_lengths[j] == 0.:             # <<<<<<<<<<<<<<
 *                 point_counts[j] = 0
 ...
 */
      __pyx_t_19 = __pyx_v_j;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_vertice_lengths.shape[0];
      __pyx_t_11 = (((*((double *) ( /* dim=0 */ (__pyx_v_vertice_lengths.data + __pyx_t_19 * __pyx_v_vertice_lengths.strides[0]) ))) == 0.) != 0);
      if (__pyx_t_11) {

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":90
 *             vertice_lengths[j] = math.sqrt((next_edge[0] - current_edge[0]) ** 2 + (next_edge[1] - current_edge[1]) ** 2)
 *             if vertice_lengths[j] == 0.:
 *                 point_counts[j] = 0             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
        __pyx_t_19 = __pyx_v_j;
        if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_point_counts.shape[0];
        *((int *) ( /* dim=0 */ (__pyx_v_point_counts.data + __pyx_t_19 * __pyx_v_point_counts.strides[0]) )) = 0;
 ...
 */
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":92
 *                 point_counts[j] = 0
 *             else:
 *                 point_counts[j] = <int>(vertice_lengths[j] / resolution) + 1             # <<<<<<<<<<<<<<
 ...
 */
      /*else*/ {
        ...
        if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_vertice_lengths.shape[0];
        __pyx_t_18 = __pyx_v_j;
        if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_point_counts.shape[0];
        *((int *) ( /* dim=0 */ (__pyx_v_point_counts.data + __pyx_t_18 * __pyx_v_point_counts.strides[0]) )) = (((int)((*((double *) ( /* dim=0 */ (__pyx_v_vertice_lengths.data + __pyx_t_19 * __pyx_v_vertice_lengths.strides[0]) ))) / __pyx_v_resolution)) + 1);
      }
      __pyx_L8:;

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":93
 *             else:
 *                 point_counts[j] = <int>(vertice_lengths[j] / resolution) + 1
 *             total_points += point_counts[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_19 = __pyx_v_j;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_point_counts.shape[0];
      __pyx_v_total_points = (__pyx_v_total_points + (*((int *) ( /* dim=0 */ (__pyx_v_point_counts.data + __pyx_t_19 * __pyx_v_point_counts.strides[0]) ))));
    }
  }

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":95
 *             total_points += point_counts[j]
 * 
 *     points = np.zeros((total_points, 3), dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_total_points); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float64); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":96
 * 
 *     points = np.zeros((total_points, 3), dtype=np.float64)
 *     cdef double[:, ::1] point_view = points             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t point_index = 0
 * 
 */
  __pyx_t_21 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_v_points, PyBUF_WRITABLE); if (unlikely(!__pyx_t_21.memview)) __PYX_ERR(0, 96, __pyx_L1_error)
  __pyx_v_point_view = __pyx_t_21;
  __pyx_t_21.memview = NULL;
  __pyx_t_21.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":97
 *     points = np.zeros((total_points, 3), dtype=np.float64)
 *     cdef double[:, ::1] point_view = points
 *     cdef Py_ssize_t point_index = 0             # <<<<<<<<<<<<<<
 * 
 *     for i in range(polygon_ends.shape[0]):
 */
  __pyx_v_point_index = 0;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":99
 *     cdef Py_ssize_t point_index = 0
 * 
 *     for i in range(polygon_ends.shape[0]):             # <<<<<<<<<<<<<<
 *         start = 0
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":100
 * 
 *     for i in range(polygon_ends.shape[0]):
 *         start = 0             # <<<<<<<<<<<<<<
 *         if i > 0:
 ...
 */
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":101
 *     for i in range(polygon_ends.shape[0]):
 *         start = 0
 *         if i > 0:             # <<<<<<<<<<<<<<
 *             start = polygon_ends[i-1] + 1
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":102
 *         start = 0
 *         if i > 0:
 *             start = polygon_ends[i-1] + 1             # <<<<<<<<<<<<<<
 *         end = polygon_ends[i]
 ...
 */
      ...
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_polygon_ends.shape[0];
      __pyx_v_start = ((*((int *) ( /* dim=0 */ (__pyx_v_polygon_ends.data + __pyx_t_19 * __pyx_v_polygon_ends.strides[0]) ))) + 1);
 ...
 */
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":103
 *         if i > 0:
 *             start = polygon_ends[i-1] + 1
 *         end = polygon_ends[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_polygon_ends.shape[0];
    __pyx_v_end = (*((int *) ( /* dim=0 */ (__pyx_v_polygon_ends.data + __pyx_t_19 * __pyx_v_polygon_ends.strides[0]) )));

    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":105
 *         end = polygon_ends[i]
 * 
 *         for j in range(start, end):             # <<<<<<<<<<<<<<
 *             current_edge = polygons[j, :]
 ...
 */
    ...
    for (__pyx_t_15 = __pyx_v_start; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":106
 * 
 *         for j in range(start, end):
 *             current_edge = polygons[j, :]             # <<<<<<<<<<<<<<
 *             next_edge = polygons[j + 1, :]
...
__PYX_XDEC_MEMVIEW(&__pyx_v_current_edge, 1);
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":107
 *         for j in range(start, end):
 *             current_edge = polygons[j, :]
 *             next_edge = polygons[j + 1, :]             # <<<<<<<<<<<<<<
 *             vertice_direction[0] = (next_edge[0] - current_edge[0]) / vertice_lengths[j]
...
__PYX_XDEC_MEMVIEW(&__pyx_v_next_edge, 1);
      ...
      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":108
 *             current_edge = polygons[j, :]
 *             next_edge = polygons[j + 1, :]
 *             vertice_direction[0] = (next_edge[0] - current_edge[0]) / vertice_lengths[j]             # <<<<<<<<<<<<<<
 *             vertice_direction[1] = (next_edge[1] - current_edge[1]) / vertice_lengths[j]
 ...
 */
      __pyx_t_19 = 0;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_next_edge.shape[0];
      __pyx_t_18 = 0;
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_current_edge.shape[0];
      __pyx_t_17 = __pyx_v_j;
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_vertice_lengths.shape[0];
      __pyx_t_12 = 0;
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_vertice_direction.shape[0];
      *((double *) ( /* dim=0 */ (__pyx_v_vertice_direction.data + __pyx_t_12 * __pyx_v_vertice_direction.strides[0]) )) = (((*((double *) ( /* dim=0 */ (__pyx_v_next_edge.data + __pyx_t_19 * __pyx_v_next_edge.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_18 * __pyx_v_current_edge.strides[0]) )))) / (*((double *) ( /* dim=0 */ (__pyx_v_vertice_lengths.data + __pyx_t_17 * __pyx_v_vertice_lengths.strides[0]) ))));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":109
 *             next_edge = polygons[j + 1, :]
 *             vertice_direction[0] = (next_edge[0] - current_edge[0]) / vertice_lengths[j]
 *             vertice_direction[1] = (next_edge[1] - current_edge[1]) / vertice_lengths[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_17 = 1;
      if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_next_edge.shape[0];
      __pyx_t_18 = 1;
      if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_current_edge.shape[0];
      __pyx_t_19 = __pyx_v_j;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_vertice_lengths.shape[0];
      __pyx_t_12 = 1;
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_vertice_direction.shape[0];
      *((double *) ( /* dim=0 */ (__pyx_v_vertice_direction.data + __pyx_t_12 * __pyx_v_vertice_direction.strides[0]) )) = (((*((double *) ( /* dim=0 */ (__pyx_v_next_edge.data + __pyx_t_17 * __pyx_v_next_edge.strides[0]) ))) - (*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_18 * __pyx_v_current_edge.strides[0]) )))) / (*((double *) ( /* dim=0 */ (__pyx_v_vertice_lengths.data + __pyx_t_19 * __pyx_v_vertice_lengths.strides[0]) ))));

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":111
 *             vertice_direction[1] = (next_edge[1] - current_edge[1]) / vertice_lengths[j]
 * 
 *             for k in range(point_counts[j]):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_19 = __pyx_v_j;
      if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_point_counts.shape[0];
      __pyx_t_22 = (*((int *) ( /* dim=0 */ (__pyx_v_point_counts.data + __pyx_t_19 * __pyx_v_point_counts.strides[0]) )));
      __pyx_t_23 = __pyx_t_22;
      for (__pyx_t_24 = 0; __pyx_t_24 < __pyx_t_23; __pyx_t_24+=1) {
        __pyx_v_k = __pyx_t_24;

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":113
 *             for k in range(point_counts[j]):
 * 
 *                 point_view[point_index, 0] = current_edge[0] + vertice_direction[0] * k * resolution             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_current_edge.shape[0];
        __pyx_t_18 = 0;
        if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_vertice_direction.shape[0];
        __pyx_t_17 = __pyx_v_point_index;
        __pyx_t_12 = 0;
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_point_view.shape[0];
        if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_point_view.shape[1];
        *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_point_view.data + __pyx_t_17 * __pyx_v_point_view.strides[0]) )) + __pyx_t_12)) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_19 * __pyx_v_current_edge.strides[0]) ))) + (((*((double *) ( /* dim=0 */ (__pyx_v_vertice_direction.data + __pyx_t_18 * __pyx_v_vertice_direction.strides[0]) ))) * __pyx_v_k) * __pyx_v_resolution));

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":114
 * 
 *                 point_view[point_index, 0] = current_edge[0] + vertice_direction[0] * k * resolution
 *                 point_view[point_index, 1] = current_edge[1] + vertice_direction[1] * k * resolution             # <<<<<<<<<<<<<<
 *                 point_view[point_index, 2] = current_edge[2]
 ...
 */
        ...
        if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_current_edge.shape[0];
        __pyx_t_19 = 1;
        if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_v_vertice_direction.shape[0];
        __pyx_t_12 = __pyx_v_point_index;
        __pyx_t_17 = 1;
        if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_point_view.shape[0];
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_point_view.shape[1];
        *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_point_view.data + __pyx_t_12 * __pyx_v_point_view.strides[0]) )) + __pyx_t_17)) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_18 * __pyx_v_current_edge.strides[0]) ))) + (((*((double *) ( /* dim=0 */ (__pyx_v_vertice_direction.data + __pyx_t_19 * __pyx_v_vertice_direction.strides[0]) ))) * __pyx_v_k) * __pyx_v_resolution));

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":115
 *                 point_view[point_index, 0] = current_edge[0] + vertice_direction[0] * k * resolution
 *                 point_view[point_index, 1] = current_edge[1] + vertice_direction[1] * k * resolution
 *                 point_view[point_index, 2] = current_edge[2]             # <<<<<<<<<<<<<<
 *                 point_index += 1
 ...
 */
        ...
        __pyx_t_17 = 2;
        if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_point_view.shape[0];
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_point_view.shape[1];
        *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_point_view.data + __pyx_t_18 * __pyx_v_point_view.strides[0]) )) + __pyx_t_17)) )) = (*((double *) ( /* dim=0 */ (__pyx_v_current_edge.data + __pyx_t_19 * __pyx_v_current_edge.strides[0]) )));

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":116
 *                 point_view[point_index, 1] = current_edge[1] + vertice_direction[1] * k * resolution
 *                 point_view[point_index, 2] = current_edge[2]
 *                 point_index += 1             # <<<<<<<<<<<<<<
 * 
 *     return points
 */
        __pyx_v_point_index = (__pyx_v_point_index + 1);
      }
    }
  }

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":118
 *                 point_index += 1
 * 
 *     return points             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("shape_optim.buildingmodel.cython_utils.shading.discretize_polygons", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_point_counts, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_vertice_lengths, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_current_edge, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_next_edge, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_vertice_direction, 1);
  __Pyx_XDECREF(__pyx_v_points);
  __PYX_XDEC_MEMVIEW(&__pyx_v_point_view, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_3discretize_polygons(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_3discretize_polygons(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_polygons = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_polygon_ends = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("discretize_polygons (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_polygons,&__pyx_n_s_polygon_ends,&__pyx_n_s_resolution,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_polygon_ends)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("discretize_polygons", 1, 3, 3, 1); __PYX_ERR(0, 66, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_resolution)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("discretize_polygons", 1, 3, 3, 2); __PYX_ERR(0, 66, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "discretize_polygons") < 0)) __PYX_ERR(0, 66, __pyx_L3_error)
      }
    ...
    __pyx_v_polygons = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_polygons.memview)) __PYX_ERR(0, 66, __pyx_L3_error)
    __pyx_v_polygon_ends = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_polygon_ends.memview)) __PYX_ERR(0, 66, __pyx_L3_error)
    __pyx_v_resolution = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_resolution == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("discretize_polygons", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 66, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("shape_optim.buildingmodel.cython_utils.shading.discretize_polygons", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_2discretize_polygons(__pyx_self, __pyx_v_polygons, __pyx_v_polygon_ends, __pyx_v_resolution);
...
static PyObject *__pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_2discretize_polygons(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_polygons, __Pyx_memviewslice __pyx_v_polygon_ends, double __pyx_v_resolution) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("discretize_polygons", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_discretize_polygons(__pyx_v_polygons, __pyx_v_polygon_ends, __pyx_v_resolution, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_polygons, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_polygon_ends, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "shape_optim/buildingmodel/cython_utils/shading.pyx":122
 * 
 * 
...
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_5visible_beam(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_visible_beam(__Pyx_memviewslice __pyx_v_shading_mask, __Pyx_memviewslice __pyx_v_sun_height, __Pyx_memviewslice __pyx_v_sun_azimuth, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  Py_ssize_t __pyx_v_boundary_count;
  Py_ssize_t __pyx_v_shading_count;
  Py_ssize_t __pyx_v_step_count;
  PyObject *__pyx_v_visible_beam = NULL;
  __Pyx_memviewslice __pyx_v_visible_beam_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  Py_ssize_t __pyx_v_k;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("visible_beam", 0);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":136
 *     """
 *     cdef Py_ssize_t i, j
 ...
 */
  __pyx_v_boundary_count = (__pyx_v_shading_mask.shape[0]);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":137
 *     cdef Py_ssize_t i, j
 *     cdef Py_ssize_t boundary_count = shading_mask.shape[0]
 *     cdef Py_ssize_t shading_count = shading_mask.shape[1]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t step_count = sun_height.shape[0]
 ...
 */
  __pyx_v_shading_count = (__pyx_v_shading_mask.shape[1]);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":138
 *     cdef Py_ssize_t boundary_count = shading_mask.shape[0]
 *     cdef Py_ssize_t shading_count = shading_mask.shape[1]
 *     cdef Py_ssize_t step_count = sun_height.shape[0]             # <<<<<<<<<<<<<<
 *     visible_beam = np.zeros((boundary_count, step_count), dtype=np.float64)
 ...
 */
  __pyx_v_step_count = (__pyx_v_sun_height.shape[0]);

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":139
 *     cdef Py_ssize_t shading_count = shading_mask.shape[1]
 *     cdef Py_ssize_t step_count = sun_height.shape[0]
 *     visible_beam = np.zeros((boundary_count, step_count), dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef double[:, ::1] visible_beam_view = visible_beam
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_boundary_count); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_step_count); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 139, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_visible_beam = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":140
 *     cdef Py_ssize_t step_count = sun_height.shape[0]
 *     visible_beam = np.zeros((boundary_count, step_count), dtype=np.float64)
 *     cdef double[:, ::1] visible_beam_view = visible_beam             # <<<<<<<<<<<<<<
 * 
 *     for k in range(boundary_count):
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(__pyx_v_visible_beam, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 140, __pyx_L1_error)
  __pyx_v_visible_beam_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":142
 *     cdef double[:, ::1] visible_beam_view = visible_beam
 * 
 *     for k in range(boundary_count):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "shape_optim/buildingmodel/cython_utils/shading.pyx":144
 *     for k in range(boundary_count):
 * 
 *         for i in range(shading_count):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_10 = __pyx_v_shading_count;
    __pyx_t_11 = __pyx_t_10;
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      __pyx_v_i = __pyx_t_12;

      /* "shape_optim/buildingmodel/cython_utils/shading.pyx":146
 *         for i in range(shading_count):
 * 
 *             for j in range(sun_azimuth.shape[0]):             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_13 = (__pyx_v_sun_azimuth.shape[0]);
      __pyx_t_14 = __pyx_t_13;
      for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
        __pyx_v_j = __pyx_t_15;

        /* "shape_optim/buildingmodel/cython_utils/shading.pyx":148
 *             for j in range(sun_azimuth.shape[0]):
 * 
 *                 if i * 360. / shading_count < sun_azimuth[j] < (i + 1) * 360. / shading_count and sun_height[j] > shading_mask[k, i]:             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_17 = __pyx_v_j;
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_sun_azimuth.shape[0];
        __pyx_t_18 = (*((double *) ( /* dim=0 */ (__pyx_v_sun_azimuth.data + __pyx_t_17 * __pyx_v_sun_azimuth.strides[0]) )));
        __pyx_t_19 = (((__pyx_v_i * 360.) / ((double)__pyx_v_shading_count)) < __pyx_t_18);
        if (__pyx_t_19) {
          __pyx_t_19 = (__pyx_t_18 < (((__pyx_v_i + 1) * 360.) / ((double)__pyx_v_shading_count)));
        }
        ...
        __pyx_t_17 = __pyx_v_j;
        if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_sun_height.shape[0];
        __pyx_t_21 = __pyx_v_k;
        __pyx_t_22 = __pyx_v_i;
        if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_shading_mask.shape[0];
        if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_shading_mask.shape[1];
        __pyx_t_20 = (((*((double *) ( /* dim=0 */ (__pyx_v_sun_height.data + __pyx_t_17 * __pyx_v_sun_height.strides[0]) ))) > (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_shading_mask.data + __pyx_t_21 * __pyx_v_shading_mask.strides[0]) ) + __pyx_t_22 * __pyx_v_shading_mask.strides[1]) )))) != 0);
        __pyx_t_16 = __pyx_t_20;
        __pyx_L10_bool_binop_done:;
        if (__pyx_t_16) {

          /* "shape_optim/buildingmodel/cython_utils/shading.pyx":150
 *                 if i * 360. / shading_count < sun_azimuth[j] < (i + 1) * 360. / shading_count and sun_height[j] > shading_mask[k, i]:
 * 
 *                     visible_beam_view[k, j] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_22 = __pyx_v_k;
          __pyx_t_21 = __pyx_v_j;
          if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_visible_beam_view.shape[0];
          if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_visible_beam_view.shape[1];
          *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_visible_beam_view.data + __pyx_t_22 * __pyx_v_visible_beam_view.strides[0]) )) + __pyx_t_21)) )) = 1.0;
 ...
 */
  ...
  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":152
 *                     visible_beam_view[k, j] = 1
 * 
 *     return visible_beam             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(__pyx_v_visible_beam);
  __pyx_r = __pyx_v_visible_beam;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_5);
  __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
  __Pyx_AddTraceback("shape_optim.buildingmodel.cython_utils.shading.visible_beam", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_visible_beam);
  __PYX_XDEC_MEMVIEW(&__pyx_v_visible_beam_view, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_5visible_beam(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_11shape_optim_13buildingmodel_12cython_utils_7shading_4visible_beam[] = "This function determines at which time steps the sun beam is obscured given a shading mask array and time series \n    of sun heights and azimuths\n    \n    Args:\n        shading_mask (numpy array):  a N by M numpy array of shadings, where N is the number of boundaries and M the \n        number of azimuths for which the shading has been calculated\n        sun_height (numpy array): a time series of sun heights\n        sun_azimuth (numpy array): a time series of sun azimuths \n\n    Returns:\n        a N by T array of 0 and 1, where T is the number of time steps of sun position provided\n    ";
static PyObject *__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_5visible_beam(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_shading_mask = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sun_height = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sun_azimuth = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("visible_beam (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_shading_mask,&__pyx_n_s_sun_height,&__pyx_n_s_sun_azimuth,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_shading_mask)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sun_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("visible_beam", 1, 3, 3, 1); __PYX_ERR(0, 122, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sun_azimuth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("visible_beam", 1, 3, 3, 2); __PYX_ERR(0, 122, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "visible_beam") < 0)) __PYX_ERR(0, 122, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_shading_mask = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_shading_mask.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_sun_height = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sun_height.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
    __pyx_v_sun_azimuth = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sun_azimuth.memview)) __PYX_ERR(0, 122, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("visible_beam", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 122, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("shape_optim.buildingmodel.cython_utils.shading.visible_beam", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_4visible_beam(__pyx_self, __pyx_v_shading_mask, __pyx_v_sun_height, __pyx_v_sun_azimuth);
...
static PyObject *__pyx_pf_11shape_optim_13buildingmodel_12cython_utils_7shading_4visible_beam(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_shading_mask, __Pyx_memviewslice __pyx_v_sun_height, __Pyx_memviewslice __pyx_v_sun_azimuth) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("visible_beam", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_11shape_optim_13buildingmodel_12cython_utils_7shading_visible_beam(__pyx_v_shading_mask, __pyx_v_sun_height, __pyx_v_sun_azimuth, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_shading_mask, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_sun_height, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_sun_azimuth, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "shape_optim.buildingmodel.cython_utils.shading.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "shape_optim.buildingmodel.cython_utils.shading.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "shape_optim.buildingmodel.cython_utils.shading.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "shape_optim.buildingmodel.cython_utils.shading._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"calculate_shading", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_1calculate_shading, METH_VARARGS|METH_KEYWORDS, 0},
  {"discretize_polygons", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_3discretize_polygons, METH_VARARGS|METH_KEYWORDS, 0},
  {"visible_beam", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11shape_optim_13buildingmodel_12cython_utils_7shading_5visible_beam, METH_VARARGS|METH_KEYWORDS, __pyx_doc_11shape_optim_13buildingmodel_12cython_utils_7shading_4visible_beam},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_shading(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_shading},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bbox_filter, __pyx_k_bbox_filter, sizeof(__pyx_k_bbox_filter), 0, 0, 1, 1},
  {&__pyx_n_s_boundary_azimuths, __pyx_k_boundary_azimuths, sizeof(__pyx_k_boundary_azimuths), 0, 0, 1, 1},
  {&__pyx_n_s_boundary_centers, __pyx_k_boundary_centers, sizeof(__pyx_k_boundary_centers), 0, 0, 1, 1},
  {&__pyx_n_s_boundary_type, __pyx_k_boundary_type, sizeof(__pyx_k_boundary_type), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_elevation_model, __pyx_k_elevation_model, sizeof(__pyx_k_elevation_model), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_polygon_ends, __pyx_k_polygon_ends, sizeof(__pyx_k_polygon_ends), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_shading_mask, __pyx_k_shading_mask, sizeof(__pyx_k_shading_mask), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_sun_azimuth, __pyx_k_sun_azimuth, sizeof(__pyx_k_sun_azimuth), 0, 0, 1, 1},
  {&__pyx_n_s_sun_height, __pyx_k_sun_height, sizeof(__pyx_k_sun_height), 0, 0, 1, 1},
 ...
 *     cdef double[:] vertice_direction = np.zeros(2, dtype=np.float64)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_int_3); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 76, __pyx_L1_error)
 ...
 *     for i in range(polygon_ends.shape[0]):
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_int_2); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 78, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initshading(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initshading(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_shading(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_shading(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_shading(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'shading' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_shading(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("shading", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_shape_optim__buildingmodel__cython_utils__shading) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "shape_optim.buildingmodel.cython_utils.shading")) {
      if (unlikely(PyDict_SetItemString(modules, "shape_optim.buildingmodel.cython_utils.shading", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":1
 * C_INIT = ""             # <<<<<<<<<<<<<<
 * cimport libc.math as math
 * import numpy as np
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_C_INIT, __pyx_kp_u__22) < 0) __PYX_ERR(0, 1, __pyx_L1_error)

  /* "shape_optim/buildingmodel/cython_utils/shading.pyx":3
 * C_INIT = ""
 * cimport libc.math as math
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init shape_optim.buildingmodel.cython_utils.shading", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init shape_optim.buildingmodel.cython_utils.shading");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
